...
- 서비스 백엔드와 운영 인프라
- Kubernetes / GitOps 기반 배포 흐름
- Codex · Claude Code · Omo 공용 에이전트 하네스
...
| [**tingle.chat**](https://tingle.chat) | 백엔드와 인프라를 담당하고 있습니다. |
...
<img src="https://img.shields.io/badge/GitOps-4A154B?style=flat-square&logo=git&logoColor=white" alt="GitOps" />
...
<img src="https://img.shields.io/badge/Drizzle-C5F74F?style=flat-square&logo=drizzle&logoColor=111111" alt="Drizzle" />
...
맥락을 보존하고, 동작을 검증하고, 여러 에이전트 호스트에서 같은 결과를 내는 도구를 선호합니다.  
서비스에서는 백엔드와 인프라를 맡아 안정적으로 운영합니다.
